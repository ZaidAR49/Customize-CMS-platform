      ...
      <section className="py-16 bg-white">
        <div className="container max-w-4xl">
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 rounded-full bg-[var(--fcps-bg-soft)] px-4 py-2 text-sm text-[var(--fcps-primary)] mb-6">
              <Calendar className="h-4 w-4" />
              تأسست عام {organization.foundedYear}
            </div>
            <h2 className="text-2xl md:text-3xl font-bold text-[var(--fcps-dark)] mb-6">
              {organization.nameAr}
            </h2>
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2 max-w-4xl mx-auto">
            <Card className="border-none shadow-[var(--fcps-shadow-card)]">
              <CardContent className="p-8">
                <div className="mb-4 flex h-14 w-14 items-center justify-center rounded-xl bg-[var(--fcps-primary)] text-white">
                  <Target className="h-7 w-7" />
                </div>
                <h3 className="mb-3 text-xl font-bold text-[var(--fcps-primary-dark)]">رسالتنا</h3>
                <p className="leading-relaxed text-[var(--fcps-gray-text)]">{organization.missionAr}</p>
              </CardContent>
            </Card>
            <Card className="border-none shadow-[var(--fcps-shadow-card)]">
              <CardContent className="p-8">
                <div className="mb-4 flex h-14 w-14 items-center justify-center rounded-xl bg-[var(--fcps-primary-light)] text-white">
                  <Eye className="h-7 w-7" />
                </div>
                <h3 className="mb-3 text-xl font-bold text-[var(--fcps-primary-dark)]">رؤيتنا</h3>
                <p className="leading-relaxed text-[var(--fcps-gray-text)]">{organization.visionAr}</p>
              </CardContent>
            </Card>
          </div>
        </div>
      ...
      <section className="py-16 bg-white">
        <div className="container max-w-2xl">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3 rounded-lg bg-[var(--fcps-bg-soft)] p-4">
              <Phone className="h-5 w-5 text-[var(--fcps-primary)]" />
              <span dir="ltr">{organization.phone}</span>
            </div>
            <div className="flex items-center gap-3 rounded-lg bg-[var(--fcps-bg-soft)] p-4">
              <Mail className="h-5 w-5 text-[var(--fcps-primary)]" />
              <span>{organization.email}</span>
            </div>
            <div className="flex items-center gap-3 rounded-lg bg-[var(--fcps-bg-soft)] p-4">
              <MapPin className="h-5 w-5 text-[var(--fcps-primary)]" />
