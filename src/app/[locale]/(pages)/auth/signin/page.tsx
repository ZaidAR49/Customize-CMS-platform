      ...
      <div className="w-full max-w-md bg-white p-8 rounded-2xl shadow-lg border border-(--fcps-bg-soft) text-center animate-in fade-in zoom-in-95 duration-500">
        ...
        <button
          ...
          className={cn(
            ...
            "hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-(--fcps-primary) focus:ring-offset-2",
            isLoading && "opacity-70 cursor-not-allowed"
          )}
        >
          {isLoading ? (
            <div className="h-5 w-5 animate-spin rounded-full border-2 border-gray-300 border-t-(--fcps-primary)" />
          ) : (
            <>
